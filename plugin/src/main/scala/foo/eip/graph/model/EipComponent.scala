 ...
 */
class EipComponent(val id: String, val eipType: String, val text: String, val semantics: CamelTypeSemantics, val psiReference: ProcessorDefinition)
...
object EipComponent {
   ...
   * @param text The text associated with this component, for instance an expression
   */
  def apply(id: String, eipType: String, text: String, semantics: CamelTypeSemantics, psiReference: ProcessorDefinition) = new EipComponent(id, eipType, text, semantics, psiReference)
}
