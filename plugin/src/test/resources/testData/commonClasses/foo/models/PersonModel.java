...
public class PersonModel {
    ...
    public PersonModel(int id, String firstName, String lastName, String number, Integer age) {
        this.id = id;
    ...
    public PersonModel(String firstName, String lastName, String number, Integer age) {
        this.firstName = firstName;
        this.lastName = lastName;
        this.number = number;
        this.age = age;
